# ☕ Programação 2 (Java) - UFRPE

Bem-vindo ao repositório da disciplina de **Programação 2**. 
Aqui estão armazenados todos os exercícios, práticas de laboratório e projetos desenvolvidos ao longo do semestre no curso de Engenharia da Computação (UFRPE-UABJ).

## 🎯 Objetivo do Repositório
Consolidar os conhecimentos em lógica de programação e avançar para o paradigma de **Orientação a Objetos (POO)** utilizando a linguagem Java.

## 🗂️ Estrutura do Curso (Aulas 01 a 10)
